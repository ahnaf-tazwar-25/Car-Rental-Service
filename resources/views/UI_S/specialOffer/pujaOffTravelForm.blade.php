...
<body>
    @section('logOut')
        <a class="btn btn-primary mr-3" href="{{ route('logout', 'travel') }}">
        @endsection
        @extends('layouts.nav')
        <br><br><br>
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="col-md-4">
                            <div class="booking-cta">
                                <h1 class="text-black font-weight-bold">Make a car reservation with 15% discount!</h1><br>
                                <p class="text-white">
                        ...
                        <div class="pl-5 col-md-8 col-md-offset-1">
                            <div class="booking-form">
                                <div class="booking-cta">
                                    <h1 class="form-header text-center text-success">

                                        Book your ride during this Durga Puja vacation

                                    </h1>
                                </div>
                                <br><br>
                                <form action="{{ route('travel_to_choose_car') }}" method="POST">
                                    @csrf
                                    <input name="name" value="{{ $fname . ' ' . $lname }}" type="hidden" >
                                    <input name="travelType" value="{{ $bookType }}" type="hidden" >
                                    <input name="email" value="{{ $email }}" type="hidden">

                                    @if ($bookType == 'One Way Travel')
                                        <input name="redirect2" value="one_way_travel" type="hidden" >
                                    @else
                                        <input name="redirect2" value="back_to_back_travel" type="hidden" >
                                    @endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input name="phone_number" value="{{ $number }}"
