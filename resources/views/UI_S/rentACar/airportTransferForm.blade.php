                    ...
                    <div class="d-flex justify-content-between">
                        <div class="col-md-4">
                            <div class="booking-cta">
                                ...
                                <p class="text-white">
                                    Please fill up the form with all the information to book a car as your ride to
                                    airport. Some of the fileds
                        ...
                        <div class="pl-5 col-md-8 col-md-offset-1">
                            <div class="booking-form">
                                <div class="booking-cta">
                                    <h1 class="form-header text-center text-success">Airport Transfer</h1>
                                </div>
                                <br><br>
                                <form action="{{ route('airportBook') }}" method="POST">
                                    @csrf

                                    <input type="hidden" name="cancelRedirect" value="rent">
                                    <input type="hidden" name="redirector" value="airportTransferForm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <select name="airport" value="{{ old('airport') }}"
                                                    class="form-control" required>
                                                    <option selected disabled></option>
                                                    <option>Barisal Airport</option>
                                                    <option>Shah Amanat International Airport</option>
                                                    <option>Cox's Bazar Airport</option>
                                                    <option>Hazrat Shahjalal International Airport</option>
                                                    <option>Jessore Airport</option>
                                                    <option>Shah Makhdum Airport</option>
                                                    <option>Saidpur Airport</option>
