                    ...
                    <div class="d-flex justify-content-between">
                        <div class="col-md-4">
                            <div class="booking-cta">
                                ...
                                <p class="text-white">
                                    Please fill up the form with all the information to book a car for a whole month
                                    starting from the starting date. Some of the fileds
                                    have been filled up for you
                                    with your account details.
                                </p>
                                <br>
                                <p class="text-white">You can change the regular pickup address anytime you want by
                                    talking with the driver!</p>
                            </div>
                        </div>
                        <div class="pl-5 col-md-8 col-md-offset-1">
                            <div class="booking-form">
                                <div class="booking-cta">
                                    <h1 class="form-header text-center text-success">Rent For entire month!</h1>
                                </div>
                                <br><br>
                                <form action="{{ route('wholeMonth') }}" method="POST">
                                    @csrf

                                    <input type="hidden" name="cancelRedirect" value="rent">
                                    <input type="hidden" name="redirector" value="monthlyCarForm">
