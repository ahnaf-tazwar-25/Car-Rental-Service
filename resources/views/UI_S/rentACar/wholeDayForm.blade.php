                ...
                <div class="d-flex justify-content-between">
                    <div class="col-md-4">
                        <div class="booking-cta">
                            ...
                            <p class="text-white">
                                Please fill up the form with all the information to book a car for an entire day. Some of the fileds
                                have been filled up for you
                                with your account details.
                            </p>
                            <br>
                            <p class="text-white">Note: If you want to cancel your booking(s), please cancel it at least
                                before 8 hours
                    ...
                    <div class="pl-5 col-md-8 col-md-offset-1">
                        <div class="booking-form">
                            <div class="booking-cta">
                                <h1 class="form-header text-center text-success">Rent For Whole Day!</h1>
                            </div>
                            <br><br>
                            <form action="{{ route('wholeDay') }}" method="POST">
                                @csrf
                                
                                <input type="hidden" name="cancelRedirect" value="rent">
                                <input type="hidden" name="redirector" value="wholeDayForm">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $fname . ' ' . $lname }}" class="form-control" type="text" disabled>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input id="txtDate" name="date" class="form-control" type="date" required>
